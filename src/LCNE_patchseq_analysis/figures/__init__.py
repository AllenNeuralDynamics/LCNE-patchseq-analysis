...
DEFAULT_EPHYS_FEATURES = [
    ...
    # Some of them should be renamed to improve readability in plots and to provide explanations of their meanings.

    # Inclusion criteria:
    #     - Use ipfx pipeline for consistency with previous papers from the Allen Institute
    #     - The number of non-NaN values should be at least 100 (without filtering, among all 333 cells)
