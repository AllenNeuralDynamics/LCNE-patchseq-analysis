...
def generate_main_figure(
    ...
    gs0_1 = gs0[1].subgridspec(1, 2, width_ratios=[1, 1], wspace=0.3)
    gs0_2 = gs0[2].subgridspec(1, 2, width_ratios=[1, 1], wspace=0.3)
    ...
    if if_save_figure:
        save_figure(fig, filename="main_figure", dpi=300, formats=("png", "pdf"), bbox_inches="tight")
